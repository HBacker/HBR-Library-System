...
"
    ...
    Sub kayıt_ol()
        ...
        nVerifer()
        If username.Text = "" Or password.Text = "" Or username.Text = ""Then
            hata_empty()
        Else
            ...
            Try
                ...
                Else
                        ...
                        Try
                            ...
                            komut.CommandText = "INSERT INTO yetkililer (yetkili,kullaniciAdi,Sifre,kayitTarihi,yetki) VALUES ('" & username.Text & "','" & username.Text & "','" & encode_pw & "','" & zaman.ToString & " - " & saat.ToString & "')"
...
(hata yeri: ex.reg_clhw)"
   ...
   saat = System.DateTime.Now.ToString("HH:mm:ss")
    ...
    Private Sub Register_Panel_Load(sender As Object, e As EventArgs) 
